...
description: >
  Generer des materiaux d'aide a la vente pour un produit VibeCraft : one-pager commercial 1 page
  et battle card concurrente sur 5 criteres.
  Utiliser des que l'utilisateur mentionne preparer un document de vente, un one-pager, une battle card,
  une fiche produit, sa demo, ou comparer VibeCraft a un concurrent, ou phrases du type "one-pager",
  "battle card", "doc de vente", "sheet de vente", "fiche produit", "preparer ma demo",
  "comparer VibeCraft a X", "besoin d'un doc pour vendre", "fais-moi un comparatif".
  Ne pas utiliser pour : emails outreach (fs-outreach), prep call decouverte (fs-prep), posts sociaux
  (mktg-social-content), landing pages long-form (mktg-copywriting).
---
