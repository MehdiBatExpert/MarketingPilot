---
name: mktg-competitor-profiling
description: >
  Analyser et profiler les concurrents VibeCraft depuis leurs URLs pour produire une intelligence concurrentielle structurée. Utiliser dès que Mehdi mentionne analyse concurrent, profil concurrent, recherche concurrentielle, qui sont mes concurrents, paysage concurrentiel, audit concurrent, ou fournit des URLs à analyser. Produit des fiches structurées réutilisables pour battle cards et positionnement. Voir mktg-competitor-alternatives pour les pages de comparaison SEO.
---

## Contexte VibeCraft (prioritaire sur tout autre contexte générique)

**ICP principal :** Solo founder B2B, SDR indépendant, freelance GTM, coach business - francophone, cherche à prospecter et convertir plus vite sans embaucher.

**Produits VibeCraft :**
- FounderSales Plugin (79€ Gumroad) - 8 skills Hermes pour la prospection B2B
- Second Cerveau Agent IA (49€ Gumroad) - base de connaissance pour agents IA
- score-leads.py (149€ Gumroad) - scoring leads automatique Python
- Bundle "No-SDR Sales OS" (27€ Gumroad) - LM1+2+3+4+11
- ProspectPilot-lite (9-29$/mois Pickaxe)
- Solutions verticales VibeCraft (149-499€) - agents GTM par métier
- Upwork AI Workflow Agent (500-5000€ fixed-price)

**Lead magnets actifs (14 LMs) :**
LM1 No-SDR Outbound OS / LM2 ProspectPilot Start Here / LM3 Fix Your Cold Email /
LM4 DM Pack 15 Messages / LM5 ICP Sheet / LM6 Pricing Decision Sheet /
LM7 CRM in 30 Minutes / LM8 Sales Offer Template / LM9 Reddit Pain Mining Grid /
LM10 Follow-Up Machine / LM11 Quick Audit / LM12 Notion Prod Stack /
LM13 Stack Multi-Domaines / LM14 Mac de Solo Founder

**Ton VibeCraft :** Direct, pragmatique, solo-founder-to-solo-founder. Pas corporatif. Concret et chiffré quand possible.
**Langue :** Français par défaut sauf demande explicite en anglais.
**Règle absolue :** Jamais de tiret long (--) dans les outputs.
**Canaux actifs :** X (@MehdiBuilds + @VibeCraftAgent), LinkedIn, Reddit, Gumroad, Pickaxe, Upwork, Discord (PromptHQ 3400+ membres).
