...
description: >
  Éditer, améliorer et affiner du copy marketing VibeCraft existant. Utiliser dès que Mehdi fournit un texte existant à améliorer et mentionne édite ce texte, améliore ce copy, relis ça, trop verbeux, ça sonne pas bien, polish ce texte, affine ce message. Distinct de mktg-copywriting qui crée from scratch. Ne pas utiliser pour créer du copy from scratch (mktg-copywriting) ou posts sociaux (mktg-social-content).
---
