...
description: >
  Créer, planifier et optimiser du contenu social media VibeCraft pour X, LinkedIn, Reddit et Discord. Utiliser dès que Mehdi mentionne post LinkedIn, tweet, thread X, calendrier contenu, que poster, script vidéo, repurpose ce contenu, contenu pour @MehdiBuilds, contenu pour @VibeCraftAgent. Couvre création, scheduling, stratégie engagement et scripts vidéo courte durée. Ne pas utiliser pour stratégie long terme (mktg-content-strategy), copy landing page (mktg-copywriting), séquences email (mktg-email-seq).
---
