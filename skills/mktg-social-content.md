...
description: >
  Créer, planifier et optimiser du contenu social media pour X, LinkedIn, Reddit et Discord. Utiliser dès qu'il s'agit de post LinkedIn, tweet, thread X, calendrier contenu, que poster, script vidéo, repurpose ce contenu, contenu pour comptes personnels ou agents autonomes. Couvre création, scheduling, stratégie engagement et scripts vidéo courte durée. Ne pas utiliser pour stratégie long terme (mktg-content-strategy), copy landing page (mktg-copywriting), séquences email (mktg-email-seq).
---
